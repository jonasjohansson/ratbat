...
final class LibraryViewModelTests: XCTestCase {
    ...
    /// Cached scans are now persisted to `{root}/.ratbat-cache.json`.
    ...
    func testSelectedTrackPublishes() async {
        ...
        // Inspector defaults closed — it's an opt-in deep-dive now.
    ...
    func testSecondLoadHitsCache() async throws {
        ...
        let cachePath = fixtures.appendingPathComponent(".ratbat-cache.json")
