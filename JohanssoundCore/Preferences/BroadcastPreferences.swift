...
public final class BroadcastPreferences: ObservableObject {
    @AppStorage("johanssound.broadcast.quality")
    private var qualityRaw: String = AudioQuality.standard.rawValue

    @AppStorage("johanssound.broadcast.sampleRate")
    private var sampleRateRaw: Int = SampleRate.hz44100.rawValue

    @AppStorage("johanssound.broadcast.port")
    public var port: Int = 18000

    @AppStorage("johanssound.broadcast.icyMetadata")
    ...
    public func resetToDefaults() {
        ...
        defaults.removeObject(forKey: "johanssound.broadcast.quality")
        defaults.removeObject(forKey: "johanssound.broadcast.sampleRate")
        defaults.removeObject(forKey: "johanssound.broadcast.port")
        defaults.removeObject(forKey: "johanssound.broadcast.icyMetadata")
        revision &+= 1
    }
}
