...
final class CacheStoreTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        tempRoot = FileManager.default.temporaryDirectory
            .appendingPathComponent("johanssound-cache-\(UUID().uuidString)")
    ...
    func testSaveAndLoadRoundTrip() throws {
        ...
        let expected = tempRoot.appendingPathComponent(".johanssound-cache.json")
    ...
    func testLoadFailsOnVersionMismatch() throws {
        ...
        let url = tempRoot.appendingPathComponent(".johanssound-cache.json")
        let garbage = """
