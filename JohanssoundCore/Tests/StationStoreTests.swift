...
final class StationStoreTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        tempRoot = FileManager.default.temporaryDirectory
            .appendingPathComponent("johanssound-stationstore-\(UUID().uuidString)")
    ...
    func testSaveAndLoadRoundTrip() throws {
        ...
        let expected = tempRoot.appendingPathComponent(".johanssound-stations.json")
    ...
    func testLoadFailsOnVersionMismatch() throws {
        let url = tempRoot.appendingPathComponent(".johanssound-stations.json")
        let garbage = """
